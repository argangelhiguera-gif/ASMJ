...
def detect_inactive_hosts(scan_hosts):
    ...
    try:
        ...
        # En Python 3 lambda sin paréntesis en los argumentos
...
if __name__ == "__main__":
    ...
    # Arreglado: scan_hosts sin espacio en el dest
    ...
    scheduler.run()  # Arreglado: faltaban los paréntesis para llamar la función
